        ...
        <ul class="space-y-2 font-medium">
            <li>
                <form method="POST" action="{{ route('logout') }}">
                    <span
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white bg-gray-100 dark:bg-gray-700 hover:cursor-pointer">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div>{{ Auth::user()->UserData->name . ' ' . Auth::user()->UserData->surnames }}</div>
